...
import { ArrowDown, CaretTop, CircleClose } from '@ehop/icons-vue'
import { usePopperContainerId } from '@ehop/hooks'
import { hasClass } from '@ehop/utils'
import { EhFormItem } from '@ehop/components/form'
import sleep from '@ehop/test-utils/sleep'
...
describe('Select', () => {
  ...
  test('create', async () => {
    ...
    const select = wrapper.findComponent({ name: 'EhSelect' })
  ...
  test('fitInputWidth', async () => {
    ...
    const selectWrapper = wrapper.findComponent({ name: 'EhSelect' })
  ...
  test('should set placeholder to label of selected option when filterable is true and multiple is false', async () => {
    ...
    const selectVm = wrapper.findComponent({ name: 'EhSelect' }).vm as any
  ...
  test('multiple select with remote load', async () => {
    ...
    const select = wrapper.findComponent({ name: 'EhSelect' }).vm
  ...
  describe('should show all options when open select dropdown', () => {
    async function testShowOptions({ filterable, multiple }: SelectProps = {}) {
      ...
      const options = wrapper.findAllComponents({ name: 'EhOption' })

...
import EhTooltip, { useTooltipContentProps } from '@ehop/components/tooltip'
import EhScrollbar from '@ehop/components/scrollbar'
import EhTag, { tagProps } from '@ehop/components/tag'
import EhIcon from '@ehop/components/icon'
import { CHANGE_EVENT, UPDATE_MODEL_EVENT } from '@ehop/constants'
import { iconPropType, isIOS, isValidComponentSize } from '@ehop/utils'
  ...
  setup(props, ctx) {
    ...
    onMounted(() => {
      states.cachedPlaceHolder = currentPlaceholder.value =
        props.placeholder || (() => t('eh.select.placeholder'))
      if (
        props.multiple &&

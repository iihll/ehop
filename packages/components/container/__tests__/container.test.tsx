...
import { getCssVariable } from '@ehop/test-utils/dom'
...
describe('Header', () => {
  ...
  test('header height', () => {
    ...
    const vm = wrapper.vm
    expect(getCssVariable(vm.$el, '--eh-header-height')).toEqual('100px')
  })
})
...
describe('Aside', () => {
  ...
  test('aside width', () => {
    ...
    const vm = wrapper.vm
    expect(getCssVariable(vm.$el, '--eh-aside-width')).toEqual('200px')
  })
})
...
describe('Footer', () => {
  ...
  test('footer height', () => {
    ...
    const vm = wrapper.vm
    expect(getCssVariable(vm.$el, '--eh-footer-height')).toEqual('100px')
  })
})

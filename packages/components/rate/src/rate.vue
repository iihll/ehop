...
import { hasClass, isArray, isObject, isString } from '@ehop/utils'
import {
  formContextKey,
  formItemContextKey,
  useFormItemInputId,
...
import type { iconPropType } from '@ehop/utils'
...
function setCurrentValue(value: number, event?: MouseEvent) {
  ...
  if (props.allowHalf && event) {
    // TODO: use cache via computed https://github.com/ehop/ehop/pull/5456#discussion_r786472092

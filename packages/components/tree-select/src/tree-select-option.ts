...
import { EhOption } from '@ehop/components/select'

const component = defineComponent({
  extends: EhOption,
  setup(props, ctx) {
    const result = (EhOption.setup as NonNullable<any>)(props, ctx)
    ...
    // @link https://github.com/ehop/ehop/blob/6df6e49db07b38d6cc3b5e9a960782bd30879c11/packages/components/select/src/option.vue#L78
    nextTick(() => {

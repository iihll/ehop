...
export default defineComponent({
  name: 'EhTreeSelect',
  // disable `EhSelect` inherit current attrs
  inheritAttrs: false,
  props: {
    ...EhSelect.props,
    ...EhTree.props,
  ...
  setup(props, context) {
    ...
    const select = ref<InstanceType<typeof EhSelect>>()
    const tree = ref<InstanceType<typeof EhTree>>()
    ...
    // expose EhTree/EhSelect methods

...
import { EVENT_CODE, UPDATE_MODEL_EVENT } from '@ehop/constants'
import EhIcon from '@ehop/components/icon'
import { Plus } from '@ehop/icons-vue'
import { useDeprecated, useNamespace, useOrderedChildren } from '@ehop/hooks'
...
export default defineComponent({
  ...
  setup(props, { emit, slots, expose }) {
    ...
    } = useOrderedChildren<TabsPaneContext>(getCurrentInstance()!, 'EhTabPane')
    ...
    useDeprecated(
      {
        ...
        scope: 'EhTabs',
        version: '2.3.0',
        ref: 'https://ehop.org/en-US/component/tabs.html#attributes',
        type: 'Attribute',
      },

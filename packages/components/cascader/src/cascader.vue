<template>
  <eh-tooltip ref="tooltipRef" :visible="popperVisible" :teleported="teleported"
    :popper-class="[nsCascader.e('dropdown'), popperClass]" :popper-options="popperOptions" :fallback-placements="[
      ...
      'right',
      'left',
    ]" :stop-popper-mouse-event="false" :gpu-acceleration="false" placement="bottom-start"
    :transition="`${nsCascader.namespace.value}-zoom-in-top`" effect="light" pure persistent @hide="hideSuggestionPanel">
    <template #default>
...
const COMPONENT_NAME = 'EhCascader'
...
const inputPlaceholder = computed(
  () => props.placeholder || t('eh.cascader.placeholder')
)

...
import { addUnit, debugWarn, isBoolean, throwError } from '@ehop/utils'
    ...
    useDeprecated(
      {
        ...
        version: '2.3.0',
        ref: 'https://ehop.org/en-US/component/switch.html#attributes',
        type: 'Attribute',
      },
...
useBatchDeprecated([
  ...
  ['"active-color"', 'CSS var `--eh-switch-on-color`', 'activeColor'],
  ['"inactive-color"', 'CSS var `--eh-switch-off-color`', 'inactiveColor'],
  ['"border-color"', 'CSS var `--eh-switch-border-color`', 'borderColor'],
])

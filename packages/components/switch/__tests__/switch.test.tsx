...
import { Checked, CircleClose } from '@ehop/icons-vue'
...
describe('Switch.vue', () => {
  ...
  test('create', () => {
    ...
    const vm = wrapper.vm
    expect(vm.$el.style.getPropertyValue('--eh-switch-on-color')).toEqual(
      '#0f0'
    )
    expect(vm.$el.style.getPropertyValue('--eh-switch-off-color')).toEqual(
      '#f00'
    )

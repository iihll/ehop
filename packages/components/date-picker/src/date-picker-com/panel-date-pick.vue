      ...
      <div :class="ppNs.e('body')">
        ...
        >
          <span :class="dpNs.e('prev-btn')">
            <button
              type="button"
              :aria-label="t(`eh.datepicker.prevYear`)"
              class="d-arrow-left"
            ...
            <button
              ...
              type="button"
              :aria-label="t(`eh.datepicker.prevMonth`)"
              :class="ppNs.e('icon-btn')"
              class="arrow-left"
          ...
          >{{ t(`eh.datepicker.month${month + 1}`) }}</span>
          <span :class="dpNs.e('next-btn')">
            <button
              v-show="currentView === 'date'"
              type="button"
              :aria-label="t(`eh.datepicker.nextMonth`)"
              :class="ppNs.e('icon-btn')"
              class="arrow-right"
            ...
            <button
              type="button"
              :aria-label="t(`eh.datepicker.nextYear`)"
              :class="ppNs.e('icon-btn')"
              class="d-arrow-right"

...
import { More } from '@ehop/icons-vue'
import {
  buildProps,
  definePropType,
  flattedChildren,
...
import EhMenuCollapseTransition from './menu-collapse-transition.vue'
import EhSubMenu from './sub-menu'
  ...
  setup(props, { emit, slots, expose }) {
    ...
    return () => {
      ...
      if (props.collapseTransition && props.mode === 'vertical') {
        return h(EhMenuCollapseTransition, () => vMenu)
      }

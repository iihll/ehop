...
import { buildProps, iconPropType, isString, throwError } from '@ehop/utils'
import { useDeprecated, useNamespace } from '@ehop/hooks'
import { ArrowDown, ArrowRight } from '@ehop/icons-vue'
...
const COMPONENT_NAME = 'EhSubMenu'
export default defineComponent({
  ...
  setup(props, { slots, expose }) {
    useDeprecated(
      {
        ...
        version: '2.3.0',
        ref: 'https://ehop.org/en-US/component/menu.html#submenu-attributes',
      },
    ...
    const vPopper = ref<InstanceType<typeof EhTooltip> | null>(null)
    ...
    const handleMouseleave = (deepDispatch = false) => {
      ...
      if (appendToBody.value && deepDispatch) {
        if (instance.parent?.type.name === 'EhSubMenu') {
    ...
    return () => {
      ...
      // temporarily mark EhPopper as any due to type inconsistency.

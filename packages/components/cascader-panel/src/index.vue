...
import EhCascaderMenu from './menu.vue'
...
import type { EhCascaderPanelContext } from './types'

export default defineComponent({
  name: 'EhCascaderPanel',
  ...
  setup(props, { emit, slots }) {
    ...
    const lazyLoad: EhCascaderPanelContext['lazyLoad'] = (node, cb) => {
      const cfg = config.value
    ...
    const expandNode: EhCascaderPanelContext['expandNode'] = (node, silent) => {
      const { level } = node
    ...
    const handleCheckChange: EhCascaderPanelContext['handleCheckChange'] = (
      node,
      checked,
      emitClose = true
    ) => {

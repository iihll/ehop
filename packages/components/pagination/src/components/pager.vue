<template>
  <ul :class="nsPager.b()" @click="onPagerClick" @keyup.enter="onEnter">
    <li
      ...
      :aria-label="t('eh.pagination.currentPage', { pager: 1 })"
      :tabindex="tabindex"
    >
      1
    </li>
    <li
      ...
      :class="prevMoreKls"
      :tabindex="tabindex"
      :aria-label="t('eh.pagination.prevPages', { pager: pagerCount - 2 })"
    ...
    <li
      ...
      :aria-label="t('eh.pagination.currentPage', { pager })"
      :tabindex="tabindex"
    >
      {{ pager }}
    </li>
    <li
      ...
      :class="nextMoreKls"
      :tabindex="tabindex"
      :aria-label="t('eh.pagination.nextPages', { pager: pagerCount - 2 })"
    ...
    <li
      ...
      :aria-label="t('eh.pagination.currentPage', { pager: pageCount })"
      :tabindex="tabindex"
    >
      {{ pageCount }}
    </li>
...
import { DArrowLeft, DArrowRight, MoreFilled } from '@ehop/icons-vue'
import { useLocale, useNamespace } from '@ehop/hooks'
import { paginationPagerProps } from './pager'
defineOptions({
  name: 'EhPaginationPager',
})

...
import { IMAGE_FAIL, IMAGE_SUCCESS, mockImageEvent } from '@ehopils/mock'
import { User } from '@ehop/icons-vue'
...
describe('Avatar.vue', () => {
  ...
  test('size is number', () => {
    ...
    expect(wrapper.attributes('style')).toContain('--eh-avatar-size: 50px;')
  })

...
import { triggerNativeCompositeClick } from '@ehop/test-utils/composite-click'
import { QuestionFilled as QuestionFilledIcon } from '@ehop/icons-vue'
import MessageBox from '../src/messageBox'
import { EhMessageBox } from '..'

const selector = '.el-overlay'
const QuestionFilled = markRaw(QuestionFilledIcon)

vi.mock('@ehop/utils/error', () => ({
  debugWarn: vi.fn(),
}))
...
describe('MessageBox', () => {
  ...
  describe('context inheritance', () => {
    it('should globally inherit context correctly', () => {
      expect(EhMessageBox._context).toBe(null)
      const testContext = {
        config: {
          globalProperties: {},
        },
      ...
      EhMessageBox.install?.(testContext as any)
      expect(EhMessageBox._context).not.toBe(null)
      expect(EhMessageBox._context).toBe(testContext._context)
      // clean up
      EhMessageBox._context = null
    })
  })

...
export interface EhMessageBoxOptions {
  /**
  ...
  title?: string | EhMessageBoxOptions
...
export type EhMessageBoxShortcutMethod = ((
  message: EhMessageBoxOptions['message'],
  title: EhMessageBoxOptions['title'],
  options?: EhMessageBoxOptions,
...
export interface IElMessageBox {
  ...
  alert: EhMessageBoxShortcutMethod

  /** Show a confirm message box */
  confirm: EhMessageBoxShortcutMethod

  /** Show a prompt message box */
  prompt: EhMessageBoxShortcutMethod

...
import { useAttrs, useNamespace } from '@ehop/hooks'
import { generateId, isArray, throwError } from '@ehop/utils'
...
const COMPONENT_NAME = 'EhAutocomplete'
defineOptions({
  name: COMPONENT_NAME,
  inheritAttrs: false,
})
...
const handleBlur = (evt: FocusEvent) => {
  setTimeout(() => {
    // validate current focus event is inside eh-tooltip-content
...
defineExpose({
  ...
  loading,
  /** @description eh-input component instance */
  inputRef,
  /** @description eh-tooltip component instance */
  popperRef,

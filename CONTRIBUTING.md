...
- Issues should be opened via [Issue Template](https://elementui.github.io/issue-generator/#/en-US?repo=ehop), fill in the form to provide
...
- Issues that with feature request should to go to [RFCs](https://github.com/ehop/rfcs/issues). This helps us managing the project.

Next section is for those who wants to help develop Ehop.
...
```shell
# If you would like to modify the website source code of https://ehop.org
...
You can follow the [LOCAL DEVELOPMENT GUIDE](https://ehop.org/en-US/guide/dev-guide.html) to do development more quickly.
...
We have a [commit template](https://ehop.org/en-US/guide/commit-examples.html)

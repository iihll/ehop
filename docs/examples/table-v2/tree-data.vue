<template>
  <eh-table-v2 v-model:expanded-row-keys="expandedRowKeys" :columns="columns" :data="treeData" :width="700"
...
import { TableV2FixedDir } from 'ehop'

import type { ExpandedRowsChangeHandler, RowExpandHandler } from 'ehop'

...
```vue
<eh-table-column label="Thumbnail" width="180">
    <template #default="scope">
        <div style="display: flex; align-items: center">
            <eh-image :preview-src-list="srcList"/>
        </div>
    </template>
</eh-table-column>
```
...
Typical issue: [#5046](https://github.com/ehop/ehop/issues/5046) [#5862](https://github.com/ehop/ehop/issues/5862) [#6919](https://github.com/ehop/ehop/issues/6919)

...
In fact, Tooltip is an extension based on [ElPopper](https://github.com/ehop/ehop/tree/dev/packages/components/popper), you can use any attribute that are allowed in ElPopper.

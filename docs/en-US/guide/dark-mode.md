...
After a long time, Ehop supports dark mode!
...
import 'ehop/theme-chalk/dark/css-vars.css'
```

> If you want an example, you can refer to [ehop-vite-starter](https://github.com/ehop/ehop-vite-starter).
...
Import it after styles of Ehop:
...
@forward 'ehop/theme-chalk/src/dark/var.scss' with (
  $bg-color: (
    'page': #0a0a0a,
    '': #626aef,
    'overlay': #1d1e1f,
...
// import 'ehop/theme-chalk/src/dark/css-vars.scss'
```

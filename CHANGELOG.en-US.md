...
- ehop exposing ElSubMenu component (#11100 by @tolking)
...
- Components [select-v2] respect `--eh-component-size` (#9706 by @holazz)
...
- ehop fix type error (#8982 by @holazz)
...
- Deps update dependency @ehop/icons-vue to v2 (#7976 by @renovate[bot])
...
[v2.2.0 release note](https://github.com/ehop/ehop/discussions/7578)
...
- Theme-chalk use getCssVar instead of var(--eh) & fix details
...
- Deps update dependency @ehop/icons-vue to v1 (#6319 by @renovate[bot])
...
- Project adding cypress into ehop (#5281 by @JeremyWuuuuu)
...
- Please refer to: [1.3.0-beta.1 Breaking change](https://github.com/ehop/ehop/discussions/5037)
...
- Upgrade @ehop/icons-vue to currentColor (#4671 by @YunYouJun)
...
- Docs replace @ehop/icons with @ehop/icons-vue (#4704 by @pdsuwwz)
...
- Style rename -color-base to --eh-bg-color (#4615 by @YunYouJun)
...
- Please refer to: [1.2.0-beta.1 Breaking change](https://github.com/ehop/ehop/discussions/4060)
...
- Dev play add @ehop/icons (#4034 by @xiaoxian521)
...
- Please refer to: [Breaking changes made in 1.1.0-beta.1](https://github.com/ehop/ehop/discussions/3020)
